...
try {
  ...
  for ($i = 0; $i < 100; $i++) {
    ...
    $login_attempts = 0;
    $lockout_time = 'NULL';
    $values .= "(null, '$user_name', '$user_last_name', '$user_email', '$user_password', '$user_address', '$user_role_name', 
    '$user_tag_color', '$user_created_at', '$user_updated_at', '$user_deleted_at', '$user_is_blocked', '$profile_picture', '$login_attempts', $lockout_time),";
  }
  ...
  '$admin_password', 'Admin address', 'admin', '#0ea5e9', $admin_created_at, $admin_updated_at, $admin_deleted_at, '$user_is_blocked', '$profile_picture', '$login_attempts', $lockout_time),";
  ...
  '$partner_password', 'Partner address', 'partner', '#0ea5e9', $partner_created_at, $partner_updated_at, $partner_deleted_at, '$user_is_blocked', '$profile_picture', '$login_attempts', $lockout_time),";
  ...
  '$employee_password', 'employee address', 'employee', '#0ea5e9', $employee_created_at, $employee_updated_at, $employee_deleted_at, '$user_is_blocked', '$profile_picture', '$login_attempts', $lockout_time),";
  ...
  '$customer_password', 'customer address', 'customer', '#0ea5e9', $customer_created_at, $customer_updated_at, $customer_deleted_at, '$user_is_blocked', '$profile_picture', '$login_attempts', $lockout_time),";
