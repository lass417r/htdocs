  ...
  <div class="p-8 bg-50-shades text-soft-white rounded-md w-full">
    ...
    <form id="user_login_form" class="flex flex-col gap-6 w-full h-full m-auto pt-8">
      ...
      <label for="user_password">
        <input name="user_password" type="password" id="password" placeholder="Password" data-validate="str" data-min="<?= out(USER_PASSWORD_MIN) ?>" data-max="<?= out(USER_PASSWORD_MAX) ?>">
      </label>
